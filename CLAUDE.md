...
🔴 **import ทับตาราง legacy = คอลัมน์ที่ระบบเราเพิ่มไว้หายไป แต่ตาราง `migrations` ยังบอกว่า "รันแล้ว"** ⇒ `php artisan migrate` **จะไม่รันซ้ำให้** ต้องซ่อมมือ (ตรวจพบ 21/09/2569)
