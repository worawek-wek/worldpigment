                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <div id="DataTables_Table_0_filter"
                                                            ...
                                                            <input onchange="loadData('{{$page_url}}/datatable')" name="month_from" value="{{ date('Y-m-d') }}" type="date" class="form-control p_search" id="exampleFormControlInput3" placeholder="" />
                                                            <span style="font-size: 22px"></span><span style="font-size: 16px">ถึงวันที่</span>
                                                            <input onchange="loadData('{{$page_url}}/datatable')" name="month_to" value="{{ date('Y-m-d') }}" type="date" class="form-control p_search" id="exampleFormControlInput4" placeholder="" />
                                                        </div>
