...
class EquipmentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data['equipments'] = Equipments::get();
    ...
    {
        $results = Equipments::orderBy('id', 'desc');
        ...
        return view('equipments/table', $data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('equipments/form', $data);
    }
    ...
    public function get_form_import($id)
    {
        $data['page_url'] = 'equipments';
        $data['equipments'] = Equipments::find($id);
        return view('equipments/import-form', $data);
    }
    ...
    public function get_history($id)
    {
        $data['page_url'] = 'equipments';
        $data['equipments'] = Equipments::find($id);
        return view('equipments/history', $data);
    }
